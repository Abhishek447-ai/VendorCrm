...
var M = (e) => {
  const c = (0, import_react.useMemo)(() => ({ ...e }), [e]), { defaultValue: r, options: o = {}, value: n, children: C, render: u, onCreate: h, onDestroy: m } = c, g = (0, import_react.useMemo)(() => R(o, c), [o, c]), l = (0, import_react.useRef)(null), t = (0, import_react.useRef)(void 0);
  (0, import_react.useImperativeHandle)(
    ...
    const i = () => {
      ...
      }), t.current = (((a = esm_default) == null ? void 0 : a.default) || esm_default)(l.current, g), h == null || h(t.current);
    }, s = () => {
  ...
  }, [g, h, m]), (0, import_react.useEffect)(() => {
    var i;
    if (t.current) {
      ...
      n !== void 0 && n !== t.current.input.value && t.current.setDate(n, false);
    }
  }, [g, n]);
  const A = (0, import_react.useCallback)((i) => {
    l.current = i;
  }, []);
  if (u)
  ...
  return o.wrap ? (0, import_jsx_runtime.jsx)("div", { className: "flatpickr", ref: A, children: C }) : (0, import_jsx_runtime.jsx)(
    "input",
    {
      onChange: x,
      ...c,
